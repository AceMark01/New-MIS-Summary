        ...
        >
          <div className="h-full overflow-y-auto mobile-scroll">
            <nav className="p-4 sm:p-5 space-y-2">
              <Link
                to="/admin/dashboard"
                className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 text-sm sm:text-base font-medium ${isActive('/admin/dashboard')
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 text-sm sm:text-base font-medium ${isActive('/admin/history-commitment')
                  ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600'
                  : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900'
                  }`}
                onClick={closeSidebar}
              ...
              <Link
                to="/admin/kpi-kra"
                className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 text-sm sm:text-base font-medium ${isActive('/admin/kpi-kra')
                  ? 'bg-blue-50 text-blue-600 border-r-4 border-blue-600'
                  : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900'
                  }`}
                onClick={closeSidebar}
