...
const AdminTodayTasks = () => {
  ...
  const handleRowClick = (task) => {
    ...
    const rows = Array.from({ length: task.todayTaskCount }, (_, i) => {
      ...
      return {
        ...
        description: `Task for ${task.taskName} - ${i + 1}`,
    ...
    setActiveDrillDown({
      ...
      count: task.todayTaskCount,
      rows,
      title: `Today's Tasks (${task.todayTaskCount})`
    });
  };
